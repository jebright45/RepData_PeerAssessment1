...
png(filename = "Total Number of Steps per Day.png")
...
png(filename = "Total Steps by Day Before Mean Replacement.png")
...
png(filename = "Total Steps by Day After Mean Replacement.png")
...
png(filename = "Weekday versus Weekend Average Steps by Interval.png")
